...
namespace SortManagerTest
{
    public class Tests
    {
        ...
        [TestCase(new int[] { 27, 10, 22, 39, 69, 68, 61, 100, 97, 73 },       new int[] { 2, 10, 27, 39, 61, 68, 69, 73, 97, 100 })]
        ...
        {
            Assert.AreEqual(sorted, Program.BubbleSort(unsorted));
        }
        ...
        {
            Assert.AreEqual(sorted, Program.MergeSort(unsorted));
        }
    }
}